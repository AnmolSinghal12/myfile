...
import { StyleSheet, Text, View, Image, TextInput, Button, alert, Alert, TouchableOpacity } from 'react-native';
  ...
  return (
    <View style={styles.container}>
      ...
      <TextInput
        ...
        onChangeText={'vanshika'}
        placeholder='Login with mobile'
        placeholderTextColor={'white'}
      />
      <Text style={{ color: 'black', fontWeight: 30,fontSize:20, alignItems: 'center', marginLeft: 200, justifyContent: 'center',marginRight:200, marginTop: 5}}>or</Text>
      <TextInput
      ...
      />
      <TouchableOpacity
        onPress={console.log('forgot passowrd')}>
